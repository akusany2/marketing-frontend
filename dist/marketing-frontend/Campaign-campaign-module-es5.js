...
var ChooseTemplateComponent = /** @class */ (function () {
    function ChooseTemplateComponent(chooseTemplateService, campaignStore) {
    ...
    ChooseTemplateComponent.prototype.getAllTemplates = function () {
        var _this = this;
        this.chooseTemplateService.getAllTemplates().subscribe(function (data) {
            _this.templates = data;
        });
    };
    ChooseTemplateComponent.prototype.selectTemplate = function (type, name, templateId) {
    ...
    ChooseTemplateComponent.ctorParameters = function () { return [
...
var ChooseTemplateService = /** @class */ (function () {
    function ChooseTemplateService(httpClient, templateStore, router, templateQuery) {
        this.httpClient = httpClient;
        this.templateStore = templateStore;
        this.router = router;
        this.templateQuery = templateQuery;
    }
    ChooseTemplateService.prototype.getAllTemplates = function () {
        return this.httpClient.get(_config__WEBPACK_IMPORTED_MODULE_5__["apiServerUrl"] + "/template/all");
    };
    ChooseTemplateService.prototype.getTemplate = function (type, name, id) {
        var _this = this;
        var template = this.httpClient
            .get(_config__WEBPACK_IMPORTED_MODULE_5__["apiServerUrl"] + "/template/" + id + "." + name, {
            responseType: "text"
        })
            .subscribe(function (data) {
            _this.templateStore.update({
                templateName: name,
                templateHtml: data,
                templateId: id
            });
            _this.router.navigate(["/campaign/template-editor"]);
        }, function (error) {
            console.log(error);
        });
        return this.templateQuery.getHasCache() ? Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["of"])() : template;
    };
    ChooseTemplateService.ctorParameters = function () { return [
...
var TemplateEditorRoutingModule = /** @class */ (function () {
    function TemplateEditorRoutingModule() {
    }
    ...
    return TemplateEditorRoutingModule;
}());
...
var TemplateEditorComponent = /** @class */ (function () {
    function TemplateEditorComponent(templateQuery, router, templateEditorService, userProfileQuery, audienceQuery, audienceService) {
        this.templateQuery = templateQuery;
        this.router = router;
    ...
    TemplateEditorComponent.prototype.readyTemplatePreview = function () {
    ...
    TemplateEditorComponent.prototype.handleTextChanges = function () {
        var _this = this;
        this.templateEditForm.valueChanges.subscribe(function (form) {
            _this.primaryTextSelector.innerText = form.primaryText;
            _this.secondaryTextSelector.innerText = form.secondaryText;
        });
    };
    TemplateEditorComponent.prototype.saveTemplate = function (templateData) {
    ...
    TemplateEditorComponent.prototype.submitTemplate = function (templateData) {
        this.saveTemplate(templateData);
    };
    TemplateEditorComponent.prototype.submitAndSelectAudience = function (templateData) {
        this.saveTemplate(templateData);
...
var TemplateEditorService = /** @class */ (function () {
    function TemplateEditorService(httpClient, templateStore, templateQuery, router) {
        this.httpClient = httpClient;
        this.templateStore = templateStore;
        this.templateQuery = templateQuery;
        this.router = router;
    }
    TemplateEditorService.prototype.createTemplate = function (template) {
        var _this = this;
        this.templateStore.setLoading(true);
        var setTemplate = this.httpClient
            .post(_config__WEBPACK_IMPORTED_MODULE_5__["apiServerUrl"] + "/template", template)
            .subscribe(function (data) {
            _this.templateStore.upsert(data["_id"], template);
            _this.templateStore.setLoading(false);
            _this.templateStore.setActive(data["_id"]);
            // this.router.navigate(["/campaign"]);
        }, function (error) {
            console.log(error);
            _this.templateStore.setLoading(false);
    ...
    TemplateEditorService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
        { type: _template_store__WEBPACK_IMPORTED_MODULE_6__["TemplateStore"] },
        { type: _template_store__WEBPACK_IMPORTED_MODULE_6__["TemplateQuery"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: function () {
                    return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./TemplateEditor/templateEditor.module */ "./src/app/Campaign/TemplateEditor/templateEditor.module.ts")).then(function (mod) { return mod.TemplateEditorModule; });
                }
            }
        ]
    }
...
var CampaignComponent = /** @class */ (function () {
    function CampaignComponent(campaignQuery, campaignStore, campaignService) {
        this.campaignQuery = campaignQuery;
        this.campaignStore = campaignStore;
        this.campaignService = campaignService;
    }
    CampaignComponent.prototype.addMetaDataCampaign = function () {
        this.campaignList$.subscribe(function (campaigns) {
